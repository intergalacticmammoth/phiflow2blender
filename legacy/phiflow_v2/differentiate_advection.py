...
def loss(velocity, market_fit):
    advected = advect.mac_cormack(market_fit, velocity, dt=1.0)
...
for iteration in app.range(warmup=1):
    loss, marker_fit, smooth_difference, gradient = gradient_function(velocity_fit, marker_fit)
