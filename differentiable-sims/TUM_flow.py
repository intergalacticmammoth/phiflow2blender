...
class TUM_flow(World):
    ...
    def __init__(self, params):
        ...
        self.fluid = self.add(Fluid(Domain(resolution=[2*self.res, 3*self.res], box=box[0:100, 0:100], boundaries=CLOSED), buoyancy_factor=buoyancy), physics=IncompressibleFlow())
