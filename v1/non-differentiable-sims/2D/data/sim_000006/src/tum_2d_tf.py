...
savedir = '../imgs/constricted_extended/scene_%d/'
...
world.add(Inflow(box[0.31*res:0.45*res, 0.5*res:0.65*res], rate = 2*rt))
world.add(Inflow(box[0.31*res:0.45*res, 1.1*res:1.5*res], rate = 2*rt))
world.add(Inflow(box[0.31*res:0.45*res, 2.05*res:2.2*res], rate = 2*rt))
world.add(Inflow(box[0.31*res:0.45*res, 2.6*res:2.75*res], rate = 2*rt))
